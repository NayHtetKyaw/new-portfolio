...
import { Card, Badge, Group, Text, Stack, Divider, ActionIcon, Modal, Timeline, Title, Container, Box, Center } from '@mantine/core';
import Image from 'next/image';
import { IconBrandGithub, IconBrandLinkedin, IconMail, IconBrandX, IconExternalLink, IconHeart, IconCode, IconPalette, IconBrain, IconRocket, IconMapPin, IconTarget, IconBulb, IconSchool, IconCalendar } from '@tabler/icons-react';
...
export const PersonalStory: React.FC<PersonalStoryProps> = ({ data }) => {
  ...
  const personalInfo = {
    background: "I&apos;m a Full Stack Developer specializing in frontend technologies, based in Bangkok, Thailand, originally from Myanmar. My journey into technology started with curiosity about how digital products work and evolved into a passion for creating meaningful user experiences.",
    
    currentFocus: "Currently working as a Full Stack Developer at Issa Compass, where I mostly work on internal products and services to help the company products, and handle operations.",
    
    philosophy: "A good programmer isn&apos;t the one who writes the prettiest code, but the one who solves problems most effectively. Beautiful code means nothing if it doesn&apos;t solve real problems for real people."
  };
  ...
  return (
    ...
    >
                 ...
                 <Stack gap="md">
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <Text size="sm" style={{ color: '#9ca3af' }}>
                      <IconMapPin size={16} style={{ marginRight: '0.5rem', display: 'inline' }} />
                      {data.location}
                    </Text>
                  </div>
                  ...
                  {/* Social Links */}
                  <div>
                    <Text size="sm" fw={500} style={{ color: '#f8fafc', marginBottom: '0.75rem', textAlign: 'center' }}>
                      Connect with me
                    </Text>
      ...
      >
        <Stack gap="md">
          <Text size="sm" style={{ color: '#ffffff', textAlign: 'center' }}>
            {selectedSkill} is one of my core competencies that I&apos;ve developed through hands-on projects and continuous learning.
          </Text>
          <div style={{ textAlign: 'center' }}>
            <IconCode size={48} style={{ color: '#ffffff', marginBottom: '1rem' }} />
      ...
      >
        <Stack gap="md">
          <Text size="sm" style={{ color: '#ffffff', textAlign: 'center' }}>
            {selectedInterest} is a passion of mine that helps me stay creative and inspired in my development work.
          </Text>
          <div style={{ textAlign: 'center' }}>
            <IconHeart size={48} style={{ color: '#ffffff', marginBottom: '1rem' }} />
            <Text size="lg" fw={500} style={{ color: '#ffffff' }}>
              {selectedInterest}
            </Text>
          </div>
