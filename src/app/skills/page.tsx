...
const skills: Skill[] = [
  ...
  },
  {
    name: "Arch",
    icon: (
      <Image src="/logos/arch.png" width={50} height={50} alt="Arch Linux" />
    ),
  },
  {
    name: "Kubernetes",
